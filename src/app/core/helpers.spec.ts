...
export const mockHackers = [
  {
    ...
    phone: '(775) 232-7260',
    statusMessage:
      'Use the optical RAM pixel, then you can navigate the online protocol!',
  ...
  },
  {
    ...
    phone: '(309) 006-4485',
    statusMessage:
      "You can't quantify the interface without programming the neural COM matrix!",
  ...
  },
  {
    ...
    phone: '(217) 365-6272',
    statusMessage:
      "I'll transmit the online HDD transmitter, that should bus the XML driver!",
  ...
  },
  {
    ...
    phone: '(674) 331-5468',
    statusMessage:
      "You can't back up the firewall without navigating the optical EXE bus!",
